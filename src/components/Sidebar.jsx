        ...
        if (normalizedRole === 'tecnico') {
          return (
            <>
              ...
              <NavLink to="/servicios-externos" className={({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-xl transition-colors group ${isActive ? 'bg-primary-700 text-white font-semibold' : 'hover:bg-primary-600 hover:text-white text-gray-300'}`}> 
                <span className="w-6 h-6 bg-primary/600/20 rounded-lg flex items-center justify-center">
        ...
        if (isMostrador) {
          return (
            <>
              ...
              <NavLink to="/servicios-externos/crear" className={({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-xl transition-colors group ${isActive ? 'bg-primary-700 text-white font-semibold' : 'hover:bg-primary-600 hover:text-white text-gray-300'}`}> 
                <span className="w-6 h-6 bg-primary/600/20 rounded-lg flex items-center justify-center">
