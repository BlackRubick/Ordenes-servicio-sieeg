...
const initialData = {
  ...
  cliente: '',
  correo: '',
  observaciones: `ACEPTO LAS CONDICIONES DE ESTA COTIZACIÓN Y CONFIRMO QUE CON *ACEPTACION* SE CONVIERTE EN UNA ORDEN DE COMPRA O PEDIDO PARA QUE SE ELABORE LA FACTURA Y ENTREGA DE LA
